...
import org.rmj.integsys.pojo.UnitEDocSysFile;
import org.rmj.parameters.EdocSysFile;

/**
 *
 * @author jef
 */
public class XMEDocSysFile implements XMRecord{
   public XMEDocSysFile(GRider foGRider, String fsBranchCd, boolean fbWithParent){
      this.poGRider = foGRider;
      if(foGRider != null){
         this.pbWithParnt = fbWithParent;
         this.psBranchCd = fsBranchCd;
         poCtrl = new EdocSysFile();
   ...
   public void setMaster(int fnCol, Object foData) {
      if(pnEditMode != EditMode.UNKNOWN){
        ...
        if(!(fnCol == poData.getColumn("sFileCode") ||
   ...
   private UnitEDocSysFile poData;
   private EdocSysFile poCtrl;
