...
import org.rmj.parameters.Module;

/**
 *
 * @author jef
 */
public class XMModule implements XMRecord{
   public XMModule(GRider foGRider, String fsBranchCd, boolean fbWithParent){
   ...
   public void setMaster(int fnCol, Object foData) {
      if(pnEditMode != EditMode.UNKNOWN){
        ...
        if(!(fnCol == poData.getColumn("sModuleCd") ||
   ...
   private UnitModule poData;
   private Module poCtrl;
